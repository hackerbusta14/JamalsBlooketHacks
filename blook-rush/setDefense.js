(async () => {
    ...
    n.remove();
            ...
            if (window.location.pathname != '/play/rush') {
                alert('You must be in a blook rush game mode to use this hack! please join one');
            } else {
                let e = reactHandler();
...
function footer() {
    ...
    element.innerHTML = `<p>Made by me <br> My <a style="color: #0000ff;" href="https://twitter.com/elonmusk" target="_blank">twitter</a></p>`;
